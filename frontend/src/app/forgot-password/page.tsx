...
import { Wifi, ArrowRight, Loader2, Mail } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Store employeeId for the next steps
        sessionStorage.setItem('reset_employee_id', employeeId);
        ...
        <GlassCard className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">
              Enter your Employee ID and we&apos;ll send a verification code to your email address
            </p>
          </div>
          ...
          {success && (
            ...
            >
              ...
              <p className="mt-1">Check your email: {maskedEmail}</p>
              <p className="mt-2 text-xs">Redirecting to verification page...</p>
            </motion.div>
          )}
